...
const STORY_SEED_PRESETS = [
  ...
  { label: '👗 Fashion Runway Spotlights & Music', prompt: 'A haute couture supermodel walking an obsidian mirror runway surrounded by spotlights. Include camera shutter clicks foley, director voiceover cues ("Perfect, keep walking!"), and deep house electronic music.' },
  { label: '🕵️ Noir Rain Investigation & Narration', prompt: 'A weary detective in a trenchcoat under a streetlamp smoking in rain-drenched 1950s Tokyo. Include gritty noir voiceover ("The city never sleeps."), rain drumming foley, and slow melancholy jazz trumpet.' },
  ...
  { label: '⚡ Superhero Rooftop Vigil & Heroic Speech', prompt: 'An armored heroine standing on a skyscraper ledge overseeing a stormy metropolis as lightning strikes. Include heroic voiceover ("I will protect this city."), thunder rumble foley, and swelling cinematic brass score.' },
  ...
  { label: '💼 Penthouse Espionage & Whispered Dialogue', prompt: 'A sleek operative hacking a glass server terminal inside a high-rise Tokyo penthouse. Include tense whispered dialogue ("Data secured."), keypress clicks foley, and suspenseful pulse synth score.' },
  ...
  { label: '🤖 Mecha Power-Up & System Voice', prompt: 'A 50-foot military mecha powering up its shoulder cannons as alarm strobes illuminate a hangar bay. Include robotic AI voice ("Weapons charged."), heavy hydraulic servo foley, and industrial metal beat.' },
  { label: '🌲 Deep Forest Creature Hunt & Whispers', prompt: 'A ranger moving silently through a misty ancient forest, her bow drawn. Include urgent whispered voiceover ("It\'s close..."), twig snap foley, and suspenseful eerie cello score.' },
  { label: '⛵ Stormy Ocean Ship & Captain\'s Shout', prompt: 'A sea captain bracing against the wooden ship wheel as massive waves crash over the deck during a hurricane. Include loud captain command ("Hold fast!"), roaring ocean storm foley, and dramatic sea shanty orchestra.' },
  { label: '🚀 Warp Speed Takeoff & Countdown', prompt: 'A pilot pulling back flight controls in a starfighter as hyperspace stars stretch into light beams. Include cockpit voice countdown ("3... 2... 1... Launch!"), engine hum foley, and cinematic sci-fi theme.' },
  { label: '🏎️ Formula 1 Pit Stop & Air Wrenches', prompt: 'A pit crew changing tires on a Formula 1 racecar in 2 seconds flat under stadium floodlights. Include mechanic leader shout ("Go go go!"), pneumatic air wrench foley, and high-energy rock score.' },
  ...
  { label: '🪐 Saturn Ring Flyby & Astronaut Logs', prompt: 'A research vessel gliding past the icy rings of Saturn with the gas giant filling the background. Include captain log narration ("Day 412 in deep orbit."), ship hum foley, and ambient space soundscape.' },
  ...
  { label: '🧪 Cyber Lab Awakening & AI Voice', prompt: 'A bio-android opening glowing blue eyes inside a glass fluid chamber as wires disconnect. Include synthetic female voice ("Initialization complete."), glass hiss foley, and pulsing ambient electronic beat.' },
  ...
  { label: '⚔️ Gladiator Arena Entrance & Crowd Roar', prompt: 'A warrior stepping into a sun-drenched Roman arena through heavy iron gates. Include gladiator battle cry ("For glory!"), roaring stadium crowd and clanging iron gates foley, and epic cinematic percussion.' },
];
