...
const RECOMMENDED_LOCAL_MODELS: RecommendedModel[] = [
  ...
  },
  {
    ...
    tag: 'hf.co/mradermacher/Qwen2.5-VL-3B-Instruct-GGUF:Q4_K_M',
    ...
    ollamaCmd: 'ollama run hf.co/mradermacher/Qwen2.5-VL-3B-Instruct-GGUF:Q4_K_M',
  },
  {
    name: 'Qwen2.5-VL 7B Instruct (Standard)',
    tag: 'hf.co/mradermacher/Qwen2.5-VL-7B-Instruct-GGUF:Q4_K_M',
    ...
    ollamaUrl: 'https://ollama.com/library/qwen2.5-vl',
    ollamaCmd: 'ollama run hf.co/mradermacher/Qwen2.5-VL-7B-Instruct-GGUF:Q4_K_M',
  },
  {
